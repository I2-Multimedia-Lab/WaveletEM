...
class CDRB(nn.Module):
    ...
    def forward(self, x, x_size):
        ...
        """        
        H , W = x_size
        x = x + self.drop_path(self.attn(self.layernorm1(self.norm1(x)), H, W))
        x = x + self.drop_path(self.ffn(self.layernorm2(self.norm2(x)), H, W))
